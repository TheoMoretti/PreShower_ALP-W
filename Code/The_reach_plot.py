...
# plt.legend(loc=[0.725, 0.75], ncol=1, title="", fancybox=True, prop={'size': 17.5})

plt.savefig("/Users/theo/Desktop/ALP_Simulation/New_code/Results/Thesis_Plots/Reach_plot_empty.pdf",  dpi=1000)
plt.show()
